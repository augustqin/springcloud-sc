package com.example.activityplatform.util.qrcode;

import com.example.activityplatform.controller.pages.front.QRController;
...
public class QRCodeUtils {
    ...
    public static void createQRCode(String codeContent, File imgSaveDir, String fileNme){
        Logger log = LoggerFactory.getLogger(QRCodeUtils.class);
        try{
